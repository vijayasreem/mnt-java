...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    Customer findByCustomerNameAndAgeAndGenderAndAadharAndAddress(String customerName, int age, String gender, String Aadhar, String address);
    ...
    Customer findByCustomerNameAndAgeAndGenderAndAadharAndAddressAndFamilyIncomeAndNumberOfDependentsAndCrifScore(String customerName, int age, String gender, String Aadhar, String address, int familyIncome, int numberOfDependents, int crifScore);
